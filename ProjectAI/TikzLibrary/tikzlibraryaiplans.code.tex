...
%   parentheses... check!)
% - the should be a standard scheme for "almost empty" actions and just 3 parameters:
%   number of precs, number of effs, and the name.
...
% Usage examples can be found in the file ``example.tex''.
...
\newcommand{\stage}[7][{{(0,0)}}]{
  \action{start}{text = {\rotatebox{90}{\textbf{#6}}},
